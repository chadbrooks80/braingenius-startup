...
2. Replace the root `Archive.zip` with a new ZIP of the project. Exclude `.git`, `node_modules`, `.next`, `references`, existing archives, secrets, and other generated or ignored non-project files inside the .env.
