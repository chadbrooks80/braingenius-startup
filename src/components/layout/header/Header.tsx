...
export default function Header() {
  return (
    <header className="sticky top-0 z-[100] border-b border-(--color-border-soft) bg-(--color-surface-strong) backdrop-blur-header shadow-[0_10px_35px_var(--color-primary-cyan)] shadow-primary-cyan/34">
