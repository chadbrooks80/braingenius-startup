...
export function Sidebar() {
  return (
    <aside className="w-60 shrink-0 flex flex-col overflow-y-auto bg-surface/74 backdrop-blur-md border-r border-surface/74">
      <div className="px-5 pt-4 pb-3 border-b border-heading/7">
        ...
        <div className="h-1.5 rounded-full mb-3 overflow-hidden bg-heading/8">
        ...
        <div className="space-y-1">
          ...
          <div className="flex justify-between items-center pt-1 border-t border-heading/7">
      ...
      <div className="px-5 pt-5 pb-3 border-b border-heading/7">
      ...
      <div className="mb-1">
        <div className="flex items-center gap-1.5 px-5 py-2.5 border-b border-heading/7">
          ...
          <span className="text-[10px] font-bold px-1.5 py-0.5 rounded-full bg-heading/7 text-heading">
            0
          </span>
        </div>
      ...
      <div className="mb-1">
        <div className="flex items-center gap-1.5 px-5 py-2.5 border-b border-heading/7">
          ...
          <span className="text-[10px] font-bold px-1.5 py-0.5 rounded-full bg-secondary/20 text-secondary-strong">
            0
          </span>
        </div>
      ...
      <div className="mb-1">
        <div className="flex items-center gap-1.5 px-5 py-2.5 border-b border-heading/7">
          ...
          <span className="text-[10px] font-bold px-1.5 py-0.5 rounded-full bg-primary/13 text-primary-strong">
            0
          </span>
        </div>
        <p className="px-5 py-2 text-[11px] text-muted italic">None yet</p>
